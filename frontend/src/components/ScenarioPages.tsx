...
export const DesignSystemPage: Component = () => (
  <main class="design-board">
    ...
    <section class="design-section"><h2><span>05</span>Focus & actions</h2><div class="sample-row action-sample"><Button tone="primary" icon="focus">Focus vehicle</Button><Button icon="pause">Pause follow</Button><Button tone="danger" icon="close">Stop following</Button><FocusPill line={line100Vehicle.lineCode ?? "100"} paused={false} onPause={() => undefined} onResume={() => undefined} onUnfocus={() => undefined} /></div></section>
