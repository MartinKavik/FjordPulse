...
export const DesignSystemPage: Component = () => (
  <main class="design-board">
    ...
    <section class="design-section topbar-sample"><h2><span>01</span>Brand & top bar</h2><div class="sample-topbar"><FjordPulseLogo /><div class="sample-search"><Icon name="search" size={20} />Search for station, place, line…<kbd>⌘ K</kbd></div></div></section>
    <section class="design-section"><h2><span>02</span>Resource status</h2><div class="sample-row"><StatusChip state="stale" label="Stale" /><StatusChip state="lost" label="Lost" /><StatusChip state="delayed" label="Updates delayed" /><StatusChip state="offline" label="Unavailable" /></div></section>
    ...
    <section class="design-section update-notice-sample"><h2><span>07</span>Update delivery</h2><div class="sample-row"><UpdateNotice notice="reconnecting" /><UpdateNotice notice="polling" /><UpdateNotice notice="unavailable" /></div></section>
  </main>
);
