...
import type { AdminEnturLog, AdminRealtime, AdminStatus, MigrationRow, RealtimeEventRow, ServiceState, WatchRow } from "../types/domain";
...
const AdminLayout: Component<{ readonly page: AdminPage; readonly children: JSX.Element; readonly username: string; readonly connectionState: ServiceState; readonly connectionLabel: string; readonly onLogout?: () => void }> = (props) => {
  ...
  return <div class="admin-shell">
    <aside class="admin-sidebar">
      ...
      <div class="admin-sidebar-bottom"><StatusChip state={props.connectionState} label={props.connectionLabel} /><button type="button" onClick={props.onLogout}><span class="avatar">{initials()}</span><span><strong>{props.username}</strong><small>Operator</small></span><Icon name="chevron" size={15} /></button></div>
    </aside>
