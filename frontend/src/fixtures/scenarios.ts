...
export const adminStatusFixture: AdminStatus = {
  ...
  dataCounts: { stations: 12_000, stationSnapshots: 24, stationTimetables: 6, currentVehicles: 7, journeySnapshots: 5, vehicleObservations: 84, watches: 4, realtimeEvents: 128, enturRequestLogs: 42 },
  ...
  tables: [
    {
      ...
      fields: [
        { name: "vehicle_id", type: "string", readonly: false, assertion: null, defaultValue: null, computedValue: null, valueExpression: null, referenceOnDelete: null, permissions: noFieldPermissions },
        { name: "journey", type: "option<record<journey_snapshot>>", readonly: false, assertion: null, defaultValue: null, computedValue: null, valueExpression: "IF record::exists($candidate) { $candidate } ELSE { NONE }", referenceOnDelete: "UNSET", permissions: noFieldPermissions },
        { name: "location", type: "computed", readonly: false, assertion: null, defaultValue: null, computedValue: "IF latitude = NONE OR longitude = NONE { NONE } ELSE { type::point([longitude, latitude]) }", valueExpression: null, referenceOnDelete: null, permissions: noFieldPermissions },
        { name: "state", type: "string", readonly: false, assertion: '$value IN ["live", "stale", "lost"]', defaultValue: null, computedValue: null, valueExpression: null, referenceOnDelete: null, permissions: noFieldPermissions },
        { name: "updated_at", type: "datetime", readonly: false, assertion: null, defaultValue: "time::now()", computedValue: null, valueExpression: null, referenceOnDelete: null, permissions: noFieldPermissions },
      ],
      indexes: [
    ...
    },
    {
      ...
      permissions: noTablePermissions,
      fields: [
        { name: "event_id", type: "string", readonly: false, assertion: null, defaultValue: null, computedValue: null, valueExpression: null, referenceOnDelete: null, permissions: noFieldPermissions },
        { name: "scope", type: "string", readonly: false, assertion: null, defaultValue: null, computedValue: null, valueExpression: null, referenceOnDelete: null, permissions: noFieldPermissions },
        { name: "created_at", type: "datetime", readonly: false, assertion: null, defaultValue: "time::now()", computedValue: null, valueExpression: null, referenceOnDelete: null, permissions: noFieldPermissions },
      ],
    ...
    },
    {
      ...
      permissions: noTablePermissions,
      fields: [
        { name: "name", type: "string", readonly: false, assertion: null, defaultValue: null, computedValue: null, valueExpression: null, referenceOnDelete: null, permissions: noFieldPermissions },
        { name: "checksum", type: "string", readonly: false, assertion: null, defaultValue: null, computedValue: null, valueExpression: null, referenceOnDelete: null, permissions: noFieldPermissions },
        { name: "applied_at", type: "datetime", readonly: false, assertion: null, defaultValue: null, computedValue: null, valueExpression: null, referenceOnDelete: null, permissions: noFieldPermissions },
      ],
